...
class AdminContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'u530738421_eZCwf', 'user' => 'u530738421_cCCbS', 'password' => '98yiIjF6b2', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setProxyDir('/home/u530738421/domains/trade-store.com.ar/public_html/var/cache/prod//doctrine/orm/Proxies');
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(false);
        $a->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $a->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('nmww_'))) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_dda95f35cc3f3e009f6a629ca7b8f19000356ea911e779eb700be117830e87a1');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/u530738421/domains/trade-store.com.ar/public_html/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/u530738421/domains/trade-store.com.ar/public_html/var/cache/prod//localization'))) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('nmww_');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_port' => '',
            'database_name' => 'u530738421_eZCwf',
            'database_user' => 'u530738421_cCCbS',
            'database_password' => '98yiIjF6b2',
            'database_prefix' => 'nmww_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'yKXskNCqM3obWtnepqoUOkrN95y6Hdh8bbD6dKk97raZQwZZydrT3P8a',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-12-28',
            'locale' => 'en-US',
            'cookie_key' => 'cdsyn8zQ21SYyu0divJYXtCChMFz0Sy4KQfjAwoarhodUrgsiFFGQY91',
            'cookie_iv' => 'BhdwQoSx',
            'new_cookie_key' => 'def00000345bc001e3b95ab460086df529d9d3f7dbb270f6ddf0557a8de624b6dbbf0b922da5030c48a6c08100cf20fea6a6cbb67c6d94e282b7f5db66c5ad66bd8562cf',
            'cache.driver' => 'array',
            'use_debug_toolbar' => true,
            'kernel.bundles' => [

            ],
            'kernel.root_dir' => '/home/u530738421/domains/trade-store.com.ar/public_html/app/',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/home/u530738421/domains/trade-store.com.ar/public_html/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                58 => 'blockreassurance',
                59 => 'gsitemap',
                60 => 'ps_legalcompliance',
                61 => 'ps_faviconnotificationbo',
            ],
            'ps_cache_dir' => '/home/u530738421/domains/trade-store.com.ar/public_html/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/home/u530738421/domains/trade-store.com.ar/public_html/var/cache/prod//doctrine/orm/Proxies',
